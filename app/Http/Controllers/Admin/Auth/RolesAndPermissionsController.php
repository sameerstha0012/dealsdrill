...
class RolesAndPermissionsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.auth.list.roles', compact('roles'));
    }
    ...
    {
        return view('admin.auth.form.role');
    }
    ...
    public function assignPermissions(Request $request, $id)
    {
        ...
        return redirect('admin/role/'.$id.'/assign/')->with('success','Permission assigned.');
    ...
    public function permissions()
    {
        ...
        return view('admin.auth.list.permissions', compact('permissions'));
    }
    ...
    {
        return view('admin.auth.form.permission');
    }
    ...
    {
        return view('admin.auth.form.permission', compact('permission'));
    }
