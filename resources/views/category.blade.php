    ...
    <div class="container">
        <div class="main-cats desktop">
            <ul>
                ...
                <li class="cat-toggle inner-toggle">
                    <a href="#">
        ...
        <div class="col-md-3 side-cat main-side-cat">
          ...
          <div class="side-menu-wrap">
            <ul class="side-main-menu">
              ...
              <!-- menu-->
              <li>
                <a href="{{ url($category->slug.'/'.$row->slug) }}">{{ ucwords($row->name) }} @if(isset($row->product)) ({{ $row->product }}) @endif </a>
                <!-- sub menu -->
                <ul class="side-sub-menu">

                @foreach($row->othercategory as $sub)

                  <li>
                    <a href="{{ url($category->slug.'/'.$row->slug.'/'.$sub->slug) }}">{{ ucwords($sub->name) }}({{ $sub->product }})</a>
                  </li>
          ...
          <div class="filters">
            ...
            <div class="filters-wrap">
              ...
              @csrf
                ...
                <input type="hidden" name="url" value="{{ $category->slug }}">
        ...
        <div class="items-wrap col-md-9 inner-items cat-items items-list-view">
          ...
          <div class="section-header">
            <div class="cat-title-wrap">
              <h2 class="cat-title">{{ ucwords($category->name) }} <button class="mobile" onClick="sider()"><i class="fas fa-bars"></i></button></h2>
            </div>
