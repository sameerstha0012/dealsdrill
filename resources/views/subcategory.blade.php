        ...
        <div class="col-md-3 side-cat main-side-cat">
          ...
          <div class="side-menu-wrap">
            <ul class="side-main-menu">
              ...
              <!-- menu-->
              <li>
                <a href="{{ url($category->slug.'/'.$subcategory->slug.'/'.$row->slug) }}">{{ ucwords($row->name) }}({{ $row->product }})</a>
              </li>
        ...
        <div class="items-wrap col-md-9 inner-items cat-items items-list-view">
          ...
          <div class="section-header">
            <div class="cat-title-wrap">
              <h2 class="cat-title">{{ ucwords($subcategory->name) }} <button class="mobile" onClick="sider()"><i class="fas fa-bars"></i></button></h2>
            </div>
